      ...
      <div className="container mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold">AnimateLearnCode</span>
            </div>
            <p className="text-gray-600 dark:text-gray-400">
              Learn HTML and CSS through beautiful, interactive animations.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/lessons/html-basics" className="text-gray-600 dark:text-gray-400 hover:text-primary dark:hover:text-primary transition-colors">
                  HTML Basics
                </Link>
              </li>
              <li>
                <Link to="/lessons/css-basics" className="text-gray-600 dark:text-gray-400 hover:text-primary dark:hover:text-primary transition-colors">
                  CSS Basics
                </Link>
              </li>
              <li>
                <Link to="/lessons/flexbox" className="text-gray-600 dark:text-gray-400 hover:text-primary dark:hover:text-primary transition-colors">
                  Flexbox
                </Link>
              </li>
              <li>
                <Link to="/lessons/grid" className="text-gray-600 dark:text-gray-400 hover:text-primary dark:hover:text-primary transition-colors">
                  CSS Grid
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-600 dark:text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} AnimateLearnCode. All rights reserved.
          </p>
